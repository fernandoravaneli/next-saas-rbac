...
CREATE TABLE "projects" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "orzganization_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_orzganization_id_fkey" FOREIGN KEY ("orzganization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
